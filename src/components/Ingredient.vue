...
<div class="ingredient box" >
     <center> <img class="picture" :src="findImage(item.image)" @click="incrementCounter">
     </center>
     <center>
      <br>
      ...
      <p>
    <center> <th @click="incrementCounter">{{item["ingredient_"+ lang]}}</th>
    </center> </p>
      <center> <p @click="incrementCounter">
